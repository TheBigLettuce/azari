...
class ScaffoldSelectionBarInherited extends StatelessWidget {
  const ScaffoldSelectionBarInherited({
    super.key,
    required this.child,
  });
  ...
  Widget build(BuildContext context) {
    ...
    return AnnotatedRegion(
      ...
      child: Scaffold(
        extendBody: true,
        resizeToAvoidBottomInset: false,
        bottomNavigationBar: _SlidingBar(actions: SelectionActions.of(context)),
        body: GestureDeadZones(
          left: true,
          right: true,
          child: Builder(
