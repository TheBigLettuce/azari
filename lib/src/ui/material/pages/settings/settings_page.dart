...
class SettingsPage extends StatelessWidget {
  ...
  static bool _isRestart = false;

  static bool get isRestart => _isRestart;
  static void restartOver() {
    _isRestart = false;
  }

  static void restartStart() {
    _isRestart = true;
  }

  static void selectBooru(
  ...
  static bool _themeChange = false;
  static bool get themeIsChanging => _themeChange;

  static void themeChangeOver() {
    _themeChange = false;
  }

  static void themeChangeStart() {
    _themeChange = true;
  }
  ...
  static Future<bool> chooseDirectoryCallback(
    ...
    current
        .copy(
          path: current.path.copy(
            path: resp.path,
            pathDisplay: resp.formattedPath,
          ),
        )
        .save();
      ...
      child: Scaffold(
        ...
        body: GestureDeadZones(
          ...
          child: CustomScrollView(
            slivers: [
              SliverAppBar(
                title: Text(l10n.settingsPageName),
              ...
              SliverPadding(
                ...
                sliver: SliverPadding(padding: padding, sliver: const _Body()),
              ),
            ],
          ),
        ),
...
class _BodyState extends State<_Body> with SettingsWatcherMixin {
  ...
  Future<void> onTap() async =>
      await SettingsPage.chooseDirectoryCallback(showDialog, context.l10n());
    ...
    return SliverPadding(
      ...
      sliver: SliverList.list(
        children: [
          _SettingsGroup(
            children: [
                ...
                onTap: () => radioDialog(
                  ...
                  (value) {
                    if (value != null && value != settings.selectedBooru) {
                      SettingsPage.selectBooru(context, settings, value);
                    }
                  },
              ...
              SwitchListTile(
                ...
                onChanged: (value) =>
                    settings.copy(extraSafeFilters: value).save(),
              ),
            ],
          ),
          _SettingsGroup(
            children: [
              ...
              ListTile(
                ...
                onTap: () => radioDialog(
                  ...
                  (value) {
                    if (value != null) {
                      SettingsPage.selectTheme(context, settings, value);
                    }
                  },
          ...
          SwitchListTile(
            title: Text(l10n.exceptionAlertTitle),
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(20),
            ),
            value: settings.exceptionAlerts,
            onChanged: (_) => settings
                .copy(exceptionAlerts: !settings.exceptionAlerts)
                .save(),
          ),
          if (const AppApi().canOpenBy)
            ListTile(
              title: Text(l10n.setUpLinksTitle),
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(20),
              ),
      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(l10n.accountsLabel, style: theme.textTheme.headlineSmall),
...
class _DanbooruAccountSettingsState extends State<DanbooruAccountSettings>
  ...
  Widget build(BuildContext context) {
    ...
    return AccountsForm(
      loginHint: l10n.usernameHint,
      apiKeyHint: l10n.apiKeyHint,
