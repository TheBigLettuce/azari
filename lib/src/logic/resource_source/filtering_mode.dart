...
enum FilteringColors {
  ...
  String translatedString(AppLocalizations l10n, ColorsNamesData data) =>
      switch (this) {
        FilteringColors.noColor => l10n.enumFilteringColorsNoColor,
        FilteringColors.red =>
          data.red.isEmpty ? l10n.enumFilteringColorsRed : data.red,
        FilteringColors.blue =>
          data.blue.isEmpty ? l10n.enumFilteringColorsBlue : data.blue,
        FilteringColors.yellow =>
          data.yellow.isEmpty ? l10n.enumFilteringColorsYellow : data.yellow,
        FilteringColors.green =>
          data.green.isEmpty ? l10n.enumFilteringColorsGreen : data.green,
        FilteringColors.purple =>
          data.purple.isEmpty ? l10n.enumFilteringColorsPurple : data.purple,
        FilteringColors.orange =>
          data.orange.isEmpty ? l10n.enumFilteringColorsOrange : data.orange,
        FilteringColors.pink =>
          data.pink.isEmpty ? l10n.enumFilteringColorsPink : data.pink,
        FilteringColors.white =>
          data.white.isEmpty ? l10n.enumFilteringColorsWhite : data.white,
        FilteringColors.brown =>
          data.brown.isEmpty ? l10n.enumFilteringColorsBrown : data.brown,
        FilteringColors.black =>
          data.black.isEmpty ? l10n.enumFilteringColorsBlack : data.black,
      };
}
...
enum SortingMode {
  ...
  IconData icons(SortingMode selected) => switch (this) {
    ...
    SortingMode.size =>
      this == selected ? Icons.square_foot_rounded : Icons.square_foot_outlined,
    SortingMode.stars =>
      this == selected ? Icons.star_rounded : Icons.star_outlined,
    SortingMode.color =>
      this == selected ? Icons.circle_rounded : Icons.circle_outlined,
  };
  ...
  String translatedString(AppLocalizations l10n) => switch (this) {
    ...
    SortingMode.color => l10n.enumSortingModeColor,
  };
}
