...
import '../gallery/android_api/android_files.dart';
import '../schemas/blacklisted_directory.dart';

class SystemGalleryDirectoriesActions {
  static GridBottomSheetAction<SystemGalleryDirectory> blacklist(
      BuildContext context, AndroidGalleryExtra extra) {
